...
def get_sqs_message():
    ...
    asset_restaurant_id_response_json_file = asset_restaurant_id_response.text
    asset_restaurant_id_response_json = json.loads(asset_restaurant_id_response_json_file)
...
def try_posting_certificate_notification(messages):
    ...
    try:
        ...
        certificate_notification_request_file= certificate_notification_request.text
        logger.info("response {}".format(certificate_notification_request_file))
...
def get_component_id(asset_restaurant_id, assets_url, k8s_name):
    ...
    assets_url_response_json_file = assets_url_response.text
    assets_url_response_json = json.loads(assets_url_response_json_file)
...
def get_deployment_details(asset_restaurant_id, assets_url, group_id):
    ...
    history_response_json_file = history_response.text
    history_response_json = json.loads(history_response_json_file)
...
def confirm_certificate_delivery(k8s_name, assets_url, asset_restaurant_id):
    ...
    property_response_json_file = property_response.text
    property_response_json = json.loads(property_response_json_file)
...
def configure():
    ...
    asset_restaurant_id_response_jsonfile = asset_restaurant_id_response.text
    assets_url_response_json = json.loads(asset_restaurant_id_response_jsonfile)
